    ...
    public function index(Request $request): View
    {
        ...
        return view('pages.dashboard', [
            ...
            'activeUser' => User::active()->count(),
          	'noEsignLetter' => $noEsignLetter,
          	'noEsignAllLetter' => $noEsignAllLetter,
            ...
            'percentageLetterTransaction' => GeneralHelper::calculateChangePercentage($yesterdayLetterTransaction, $todayLetterTransaction),
          	'percentageEsignAverage' => GeneralHelper::calculateChangePercentage(round($esignAverageBefore / $days_before), round($esignAverage / $days)),
