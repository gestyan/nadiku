    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.incoming_self') || \Illuminate\Support\Facades\Route::is('transaction.disposition.*') ? 'active' : '' }}">
                ...
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.outgoing.*') ? 'active' : '' }}">
              	...
              	@if(auth()->user()->role != 'admin')
              	<li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.outgoing_all') ? 'active' : '' }}">
                    <a href="{{ url('transaction/outgoing/all') }}" class="menu-link">
                        <div
                            data-i18n="Surat Keluar (All)">Surat Keluar (All)</div>
                    </a>
                </li>
              	@endif
            </ul>
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('agenda.outgoing') ? 'active' : '' }}">
                    <a href="{{ route('agenda.outgoing') }}" class="menu-link">
                        <div
                            data-i18n="Surat Keluar (Pribadi)">Surat Keluar (Pribadi)</div>
                    </a>
                </li>
                <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('agenda.outgoing.list') ? 'active' : '' }}">
                    <a href="{{ route('agenda.outgoing.list') }}" class="menu-link">
                        <div
                            data-i18n="Surat Keluar (Semua)">Surat Keluar (Semua)</div>
                    </a>
                </li>
            </ul>
        </li>
