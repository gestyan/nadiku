<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('home') }}" class="app-brand-link">
            <img src="{{ asset('logo-black.jpg') }}" alt="{{ config('app.name') }}" width="35">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                @if (auth()->user()->role == 'kabagum')
                    <li
                        class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.incoming_self') || \Illuminate\Support\Facades\Route::is('transaction.disposition.*') ? 'active' : '' }}">
                        <a href="{{ url('transaction/incoming/self') }}" class="menu-link">
                            <div data-i18n="Surat Masuk (Pribadi)">Surat Masuk (Pribadi)</div>
                        </a>
                    </li>
                @endif
                ...
                <li
                    ...
                    <a href="{{ route('transaction.incoming.index') }}" class="menu-link">
                        @if (auth()->user()->role == 'kabagum')
                            <div data-i18n="Surat Masuk (All)">Surat Masuk (All)</div>
                        @else
                ...
                <li
                    ...
                    <a href="{{ route('transaction.outgoing.index') }}" class="menu-link">
                        @if (auth()->user()->role != 'admin')
                            <div data-i18n="Surat Keluar (Pribadi)">Surat Keluar (Pribadi)</div>
                        @else
                ...
                @if (auth()->user()->role != 'admin')
                    <li
                        class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.outgoing_all') ? 'active' : '' }}">
                        <a href="{{ url('transaction/outgoing/all') }}" class="menu-link">
                            <div data-i18n="Surat Keluar (All)">Surat Keluar (All)</div>
                        </a>
                    </li>
                @endif
            </ul>
        ...
        <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('agenda.*') ? 'active open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li
                    class="menu-item {{ \Illuminate\Support\Facades\Route::is('agenda.outgoing.list') ? 'active' : '' }}">
                    <a href="{{ route('agenda.outgoing.list') }}" class="menu-link">
                        <div data-i18n="Surat Keluar (Semua)">Surat Keluar (Semua)</div>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <!-- Template Letter -->
        <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('pages.template') ? 'active' : '' }}">
            <a href="{{ route('pages.template') }}" class="menu-link">
