...
<table>
    ...
    @foreach($data as $letter)
        <tr>
            <td>{{ $letter->disposition_number }}</td>
            <td>{{ $letter->reference_number }}</td>
            <td>{{ $letter->from }}</td>
            <td>{{ $letter->formatted_letter_date }}</td>
            <td>{{ $letter->note }}</td>
          	<td>{{ $letter->allDispositions->pluck('disposition_to_name')->pluck('name') }}</td>
            <td>{{ ($letter->allDispositions->first()) ? $letter->allDispositions->first()->content : "" }}</td>
        </tr>
    @endforeach
    </tbody>
</table>
